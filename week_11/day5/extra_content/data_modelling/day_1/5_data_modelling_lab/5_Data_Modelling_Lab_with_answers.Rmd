---
title: "Data Modelling Lab with Answers"
output:
  html_document:
    toc: true
    toc_float: true
...
The complete model is available in model file PartySpaceEvents_LDM_V1.0.ndml

Model diagram:

![Party Space Events LDM Diagram](images/Party Spaces Event Company LDMV1.0.png)
