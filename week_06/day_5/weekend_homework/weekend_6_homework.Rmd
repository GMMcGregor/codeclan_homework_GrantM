...
We treat is_domesticated as the response variable and sleep_total as the explanatory variable in this relationship, with ‘domesticated’ as the ‘success’ category.
...
observed_stat <- domesticated_animals %>% 
  specify(is_domesticated ~ vote, success = "domesticated") %>% 
